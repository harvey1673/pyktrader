...
class ZeroSpreadedTermStructure(YieldTermStructure):
    ...
    def __init__(self, curveHandle, spreadHandle):
        this = _QuantLib.new_ZeroSpreadedTermStructure(curveHandle, spreadHandle)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class SpreadedLinearZeroInterpolatedTermStructure(YieldTermStructure):
    ...
    def __init__(self, curveHandle, spreadHandles, dates):
        this = _QuantLib.new_SpreadedLinearZeroInterpolatedTermStructure(curveHandle, spreadHandles, dates)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class BlackVarianceSurface(BlackVolTermStructure):
    ...
    def __init__(self, referenceDate, cal, dates, strikes, blackVols, dayCounter, lower, upper, interpolator):
        this = _QuantLib.new_BlackVarianceSurface(referenceDate, cal, dates, strikes, blackVols, dayCounter, lower, upper, interpolator)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class FixedRateCoupon(Coupon):
    ...
    def __init__(self, paymentDate, nominal, rate, dayCounter, startDate, endDate, refPeriodStart, refPeriodEnd, exCouponDate):
        this = _QuantLib.new_FixedRateCoupon(paymentDate, nominal, rate, dayCounter, startDate, endDate, refPeriodStart, refPeriodEnd, exCouponDate)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class CappedFlooredCoupon(FloatingRateCoupon):
    ...
    def __init__(self, underlying, cap, floor):
        this = _QuantLib.new_CappedFlooredCoupon(underlying, cap, floor)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class IborCoupon(FloatingRateCoupon):
    ...
    def __init__(self, paymentDate, nominal, startDate, endDate, fixingDays, index, gearing=1.0, spread=0.0, refPeriodStart, refPeriodEnd, dayCounter):
        this = _QuantLib.new_IborCoupon(paymentDate, nominal, startDate, endDate, fixingDays, index, gearing, spread, refPeriodStart, refPeriodEnd, dayCounter)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class CmsCoupon(FloatingRateCoupon):
    ...
    def __init__(self, paymentDate, nominal, startDate, endDate, fixingDays, index, gearing=1.0, spread=0.0, refPeriodStart, refPeriodEnd, dayCounter, isInArrears=False):
        this = _QuantLib.new_CmsCoupon(paymentDate, nominal, startDate, endDate, fixingDays, index, gearing, spread, refPeriodStart, refPeriodEnd, dayCounter, isInArrears)
        try:
            self.this.append(this)
        except:
            self.this = this
...
def FixedRateLeg(schedule, dayCount, nominals, couponRates, paymentAdjustment=Following, firstPeriodDayCount):
    return _QuantLib.FixedRateLeg(schedule, dayCount, nominals, couponRates, paymentAdjustment, firstPeriodDayCount)
FixedRateLeg = _QuantLib.FixedRateLeg

def IborLeg(nominals, schedule, index, paymentDayCounter, paymentConvention=Following, fixingDays, gearings, spreads, caps, floors, isInArrears=False):
    return _QuantLib.IborLeg(nominals, schedule, index, paymentDayCounter, paymentConvention, fixingDays, gearings, spreads, caps, floors, isInArrears)
IborLeg = _QuantLib.IborLeg

def CmsLeg(nominals, schedule, index, paymentDayCounter, paymentConvention=Following, fixingDays, gearings, spreads, caps, floors, isInArrears=False):
    return _QuantLib.CmsLeg(nominals, schedule, index, paymentDayCounter, paymentConvention, fixingDays, gearings, spreads, caps, floors, isInArrears)
CmsLeg = _QuantLib.CmsLeg

def CmsZeroLeg(nominals, schedule, index, paymentDayCounter, paymentConvention=Following, fixingDays, gearings, spreads, caps, floors):
    return _QuantLib.CmsZeroLeg(nominals, schedule, index, paymentDayCounter, paymentConvention, fixingDays, gearings, spreads, caps, floors)
...
class MCEuropeanEngine(PricingEngine):
    ...
    def __init__(self, process, traits, timeSteps, timeStepsPerYear, brownianBridge=False, antitheticVariate=False, requiredSamples, requiredTolerance, maxSamples, seed=0):
        this = _QuantLib.new_MCEuropeanEngine(process, traits, timeSteps, timeStepsPerYear, brownianBridge, antitheticVariate, requiredSamples, requiredTolerance, maxSamples, seed)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class MCBarrierEngine(PricingEngine):
    ...
    def __init__(self, process, traits, timeSteps, timeStepsPerYear, brownianBridge=False, antitheticVariate=False, requiredSamples, requiredTolerance, maxSamples, isBiased=False, seed=0):
        this = _QuantLib.new_MCBarrierEngine(process, traits, timeSteps, timeStepsPerYear, brownianBridge, antitheticVariate, requiredSamples, requiredTolerance, maxSamples, isBiased, seed)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class MCDiscreteArithmeticAPEngine(PricingEngine):
    ...
    def __init__(self, process, traits, brownianBridge=False, antitheticVariate=False, controlVariate=False, requiredSamples, requiredTolerance, maxSamples, seed=0):
        this = _QuantLib.new_MCDiscreteArithmeticAPEngine(process, traits, brownianBridge, antitheticVariate, controlVariate, requiredSamples, requiredTolerance, maxSamples, seed)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class MCDiscreteArithmeticASEngine(PricingEngine):
    ...
    def __init__(self, process, traits, brownianBridge=False, antitheticVariate=False, requiredSamples, requiredTolerance, maxSamples, seed=0):
        this = _QuantLib.new_MCDiscreteArithmeticASEngine(process, traits, brownianBridge, antitheticVariate, requiredSamples, requiredTolerance, maxSamples, seed)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class MCDiscreteGeometricAPEngine(PricingEngine):
    ...
    def __init__(self, process, traits, brownianBridge=False, antitheticVariate=False, requiredSamples, requiredTolerance, maxSamples, seed=0):
        this = _QuantLib.new_MCDiscreteGeometricAPEngine(process, traits, brownianBridge, antitheticVariate, requiredSamples, requiredTolerance, maxSamples, seed)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class MCEuropeanBasketEngine(PricingEngine):
    ...
    def __init__(self, process, traits, timeSteps, timeStepsPerYear, brownianBridge=False, antitheticVariate=False, requiredSamples, requiredTolerance, maxSamples, seed=0):
        this = _QuantLib.new_MCEuropeanBasketEngine(process, traits, timeSteps, timeStepsPerYear, brownianBridge, antitheticVariate, requiredSamples, requiredTolerance, maxSamples, seed)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class MCAmericanBasketEngine(PricingEngine):
    ...
    def __init__(self, process, traits, timeSteps, timeStepsPerYear, brownianBridge=False, antitheticVariate=False, requiredSamples, requiredTolerance, maxSamples, seed=0):
        this = _QuantLib.new_MCAmericanBasketEngine(process, traits, timeSteps, timeStepsPerYear, brownianBridge, antitheticVariate, requiredSamples, requiredTolerance, maxSamples, seed)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class MCEverestEngine(PricingEngine):
    ...
    def __init__(self, process, traits, timeSteps, timeStepsPerYear, brownianBridge=False, antitheticVariate=False, requiredSamples, requiredTolerance, maxSamples, seed=0):
        this = _QuantLib.new_MCEverestEngine(process, traits, timeSteps, timeStepsPerYear, brownianBridge, antitheticVariate, requiredSamples, requiredTolerance, maxSamples, seed)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class MCHimalayaEngine(PricingEngine):
    ...
    def __init__(self, process, traits, brownianBridge=False, antitheticVariate=False, requiredSamples, requiredTolerance, maxSamples, seed=0):
        this = _QuantLib.new_MCHimalayaEngine(process, traits, brownianBridge, antitheticVariate, requiredSamples, requiredTolerance, maxSamples, seed)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class PiecewiseZeroInflation(ZeroInflationTermStructure):
    ...
    def __init__(self, referenceDate, calendar, dayCounter, lag, frequency, indexIsInterpolated, baseRate, nominalTS, instruments, accuracy=1.0e-12, i):
        this = _QuantLib.new_PiecewiseZeroInflation(referenceDate, calendar, dayCounter, lag, frequency, indexIsInterpolated, baseRate, nominalTS, instruments, accuracy, i)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class PiecewiseYoYInflation(YoYInflationTermStructure):
    ...
    def __init__(self, referenceDate, calendar, dayCounter, lag, frequency, indexIsInterpolated, baseRate, nominalTS, instruments, accuracy=1.0e-12, i):
        this = _QuantLib.new_PiecewiseYoYInflation(referenceDate, calendar, dayCounter, lag, frequency, indexIsInterpolated, baseRate, nominalTS, instruments, accuracy, i)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class ZeroCouponBond(Bond):
    ...
    def __init__(self, settlementDays, calendar, faceAmount, maturityDate, paymentConvention, redemption=100.0, issueDate):
        this = _QuantLib.new_ZeroCouponBond(settlementDays, calendar, faceAmount, maturityDate, paymentConvention, redemption, issueDate)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class FixedRateBond(Bond):
    ...
    def __init__(self, settlementDays, faceAmount, schedule, coupons, paymentDayCounter, paymentConvention, redemption=100.0, issueDate, paymentCalendar, exCouponPeriod, exCouponCalendar, exCouponConvention=Unadjusted, exCouponEndOfMonth=False):
        this = _QuantLib.new_FixedRateBond(settlementDays, faceAmount, schedule, coupons, paymentDayCounter, paymentConvention, redemption, issueDate, paymentCalendar, exCouponPeriod, exCouponCalendar, exCouponConvention, exCouponEndOfMonth)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class FloatingRateBond(Bond):
    ...
    def __init__(self, settlementDays, faceAmount, schedule, index, paymentDayCounter, paymentConvention=Following, fixingDays, gearings, spreads, caps, floors, inArrears=False, redemption=100.0, issueDate):
        this = _QuantLib.new_FloatingRateBond(settlementDays, faceAmount, schedule, index, paymentDayCounter, paymentConvention, fixingDays, gearings, spreads, caps, floors, inArrears, redemption, issueDate)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class CmsRateBond(Bond):
    ...
    def __init__(self, settlementDays, faceAmount, schedule, index, paymentDayCounter, paymentConvention, fixingDays, gearings, spreads, caps, floors, inArrears=False, redemption=100.0, issueDate):
        this = _QuantLib.new_CmsRateBond(settlementDays, faceAmount, schedule, index, paymentDayCounter, paymentConvention, fixingDays, gearings, spreads, caps, floors, inArrears, redemption, issueDate)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class CPIBond(Bond):
    ...
    def __init__(self, settlementDays, faceAmount, growthOnly, baseCPI, observationLag, cpiIndex, observationInterpolation, schedule, coupons, accrualDayCounter, paymentConvention=ModifiedFollowing, issueDate, paymentCalendar, exCouponPeriod, exCouponCalendar, exCouponConvention=Unadjusted, exCouponEndOfMonth=False):
        this = _QuantLib.new_CPIBond(settlementDays, faceAmount, growthOnly, baseCPI, observationLag, cpiIndex, observationInterpolation, schedule, coupons, accrualDayCounter, paymentConvention, issueDate, paymentCalendar, exCouponPeriod, exCouponCalendar, exCouponConvention, exCouponEndOfMonth)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class CapFloor(Instrument):
    ...
    def impliedVolatility(self, price, curve, guess, accuracy=1.0e-4, maxEvaluations=100, minVol=1.0e-7, maxVol=4.0):
        return _QuantLib.CapFloor_impliedVolatility(self, price, curve, guess, accuracy, maxEvaluations, minVol, maxVol)
...
class ChiSquareDistribution(object):
    ...
    def __init__(self, df):
        this = _QuantLib.new_ChiSquareDistribution(df)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def __call__(self, x):
        return _QuantLib.ChiSquareDistribution___call__(self, x)
...
class NonCentralChiSquareDistribution(object):
    ...
    def __init__(self, df, ncp):
        this = _QuantLib.new_NonCentralChiSquareDistribution(df, ncp)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def __call__(self, x):
        return _QuantLib.NonCentralChiSquareDistribution___call__(self, x)
...
class InverseNonCentralChiSquareDistribution(object):
    ...
    def __init__(self, df, ncp, maxEvaluations=10, accuracy=1e-8):
        this = _QuantLib.new_InverseNonCentralChiSquareDistribution(df, ncp, maxEvaluations, accuracy)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def __call__(self, x):
        return _QuantLib.InverseNonCentralChiSquareDistribution___call__(self, x)
...
class GammaDistribution(object):
    ...
    def __init__(self, a):
        this = _QuantLib.new_GammaDistribution(a)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def __call__(self, x):
        return _QuantLib.GammaDistribution___call__(self, x)
...
class Money(object):
    ...
    def __div__(self, *args):
        return _QuantLib.Money___div__(self, *args)
...
class AssetSwap(Swap):
    ...
    def __init__(self, payFixedRate, bond, bondCleanPrice, index, spread, floatSchedule, floatingDayCount, parAssetSwap=True):
        this = _QuantLib.new_AssetSwap(payFixedRate, bond, bondCleanPrice, index, spread, floatSchedule, floatingDayCount, parAssetSwap)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class CubicBSplinesFitting(FittingMethod):
    ...
    def __init__(self, knotVector, constrainAtZero=True):
        this = _QuantLib.new_CubicBSplinesFitting(knotVector, constrainAtZero)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class SimplePolynomialFitting(FittingMethod):
    ...
    def __init__(self, degree, constrainAtZero=True):
        this = _QuantLib.new_SimplePolynomialFitting(degree, constrainAtZero)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class HaltonRsg(object):
    ...
    def __init__(self, dimensionality):
        this = _QuantLib.new_HaltonRsg(dimensionality)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class SobolRsg(object):
    ...
    def __init__(self, dimensionality, seed=0):
        this = _QuantLib.new_SobolRsg(dimensionality, seed)
        try:
            self.this.append(this)
        except:
            self.this = this
