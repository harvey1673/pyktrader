...
class TurtleTrader(Strategy):
	def __init__(self, name, instIDs, agent, capital):
		...
		self.daily_func = [ 
					...
					BaseObject(name = 'DONCH_H20', sfunc=fcustom(data_handler.DONCH_H, n=20), rfunc=fcustom(data_handler.donch_h, n=20)),\
					...
					BaseObject(name = 'DONCH_L55', sfunc=fcustom(data_handler.DONCH_L, n=55), rfunc=fcustom(data_handler.donch_l, n=55)) 
					]	
		self.min_func = {}
		self.pos_ratio = 0.01
		self.stop_loss = 2.0
